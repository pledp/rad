...
impl PresentationContextDefinitionResult {
    pub fn new(context_id: u8, transfer_syntax: String, result: PresentationContextResult) -> Self {
        Self {
            context_id,
            transfer_syntax,
            result,
...
mod tests {
    use crate::ul::service::{
        PresentationContextDefinitionListBuilder, PresentationContextDefinitionListBuilderError,
    };
